...
/**
 * Move paint: underlay trail (old screen rect \ new), blit mover at new,
 * re-blit windows above over old∪new.  Geometry comes only from the
 * coordinates — does not read or write c->x/y (input owns the live position).
